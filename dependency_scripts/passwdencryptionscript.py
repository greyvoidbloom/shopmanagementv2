# shoutout to Raoof Arakkal from stackoverflow ion even know how this works he a real g
#i just modified this code to use it from other files lol
#import kinda botched cause its directed from root directory
if __name__ == "__main__":
    from packageloader import LOADER
else:
    from dependency_scripts.packageloader import LOADER
loader = LOADER(['pycryptodome'])
